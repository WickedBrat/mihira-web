...
interface GuidanceIconProps {
  size?: number;
  color?: string;
}

export function GuidanceIcon({ size = 24, color = '#000' }: GuidanceIconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 -960 960 960" color={color}>
      <Path
        fill="currentColor"
