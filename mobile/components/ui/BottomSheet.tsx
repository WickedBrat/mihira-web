...
export function BottomSheet({
  ...
  const sheet = (
    ...
    >
      <AppBlurView intensity={60} tint={isDark ? 'dark' : 'light'} className="absolute inset-0" />
      <View className="absolute inset-0 bg-[rgba(250,247,242,0.88)] dark:bg-[rgba(19,19,19,0.72)]" />
