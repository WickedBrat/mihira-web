...
class Plane {
  ...
  createMesh() {
    return new THREE.Mesh(
      new THREE.PlaneGeometry(this.planeSize, this.planeSize, this.planeSize, this.planeSize),
      new THREE.RawShaderMaterial({
        ...
        fragmentShader: `
          ...
          void main(void) {
            float opacity = clamp((172.0 - length(vPosition)) / 220.0, 0.0, 1.0) * 0.95;
            vec3 color = vec3(0.82, 0.84, 0.8);
