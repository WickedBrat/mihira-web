...
const PAIN_THREAD: Record<string, string> = {
  'I am overthinking a decision': 'The clarity you found here is worth keeping.',
  'I feel burned out': 'You came here carrying burnout. Don\'t lose this thread.',
  'I am looking for direction': 'You came here looking for direction. This is a start.',
  'I feel far from my roots': 'Your roots are here now. Keep them close.',
  'My mind will not settle': 'This is a place your mind can return to. Keep it.',
  'I am under pressure': 'You\'re under pressure. This guidance was made for exactly that.',
  'I want to deepen my practice': 'Your practice lives here now. Keep building it.',
  'I want to reconnect with myself': 'Your path back to yourself starts here. Keep it.',
  'I am seeking more presence': 'You found something worth returning to. Keep it.',
};
...
export default function Screen12() {
  ...
  const painSubtitle =
    (data.painPoints[0] && PAIN_THREAD[data.painPoints[0]]) ||
